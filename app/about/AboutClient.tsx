      ...
      <section className="py-16 md:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
            ...
            >
              <Image
                src="/clientphoto1.jpeg"
                alt="Client engagement and professional relations"
                width={551}
                height={853}
                priority
                className="w-full h-full object-cover transition-transform duration-300 md:hover:scale-[1.03]"
              />
            </motion.div>
            ...
            >
              <Image
                src="/clientphoto2.jpeg"
                alt="Professional client interaction"
                width={408}
                height={408}
                className="w-full h-full object-cover transition-transform duration-300 md:hover:scale-[1.03]"
              />
          ...
          <p className="text-lg text-muted-foreground leading-relaxed mb-4">
            My expertise spans across press release writing, media relations, crisis communications, brand positioning, and strategic communication planning.
          </p>

          <p className="text-lg text-muted-foreground leading-relaxed">
            Based in Nairobi, Kenya, I work with clients throughout East Africa, helping them navigate the complex media landscape.
          </p>
        </div>
      </section>
